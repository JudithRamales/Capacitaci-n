...
$sql = "SELECT aceptacion FROM usuarios WHERE id_usuario = $id_usuario";
...
if(mysqli_num_rows($resultado) > 0) {
    ...
    $ruta_archivo = $fila['aceptacion'];

    

    // Verificar si el archivo existe en el servidor
    if($ruta_archivo != null || $ruta_archivo !="") {
        ...
        <body>
            ...
            <main class="content-wrapper">
                ...
                <div class="card">
                        ...
                        <p class="card-text">Tu carta de aceptacion ya ha sido subida y puedes descargala.</p>
                    </div>
    ...
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
        ...
        <body>
            ...
            <main class="content-wrapper">
                <section class="hero-section">
                <div class="card">
                        <h5 class="card-title title-center color-black">¡AUN NO!</h5>
                        <p class="card-text">Tu carta no ha sido subida aun intenta de nuevo en un par de dias.</p>
                    </div>
                    <div class="iframe-container">
