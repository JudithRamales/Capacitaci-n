...
function aprobarAscension($id_usuario) {
    global $conexion;
    // Consulta SQL para actualizar el nivel de usuario a 3
    $sql = "UPDATE usuarios SET nivel_usuario = 3 WHERE id_usuario = $id_usuario";
...
if(isset($_GET['id_usuario'])) {
    ...
    echo "<h2 class='textlayout1'>¿Estás seguro de descender a este usuario?</h2>";
    echo "<p class='textlayout'> Al aceptar, el usuario será descender, lo que perdera todos los privilegios de su respetivo cargo.</p>";
    ...
    if (isset($_POST['aprobar'])) {
        ...
        if (aprobarAscension($id_usuario)) {
            echo "<p>se ha descendido correctamente.</p>";
        } else {
