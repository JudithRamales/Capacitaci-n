...
$sql_total_colegas = "SELECT COUNT(*) AS total_colegas FROM usuarios WHERE nivel_usuario = '3'";
...
$sql_colegas_confirmados = "SELECT COUNT(*) AS colegas_confirmados FROM usuarios WHERE nivel_usuario = '3' AND CONFIDENCIAL = 1";
...
$sql_colegas_no_confirmados = "SELECT COUNT(*) AS colegas_no_confirmados FROM usuarios WHERE nivel_usuario = '3' AND CONFIDENCIAL = 0";
            ...
            <div class="contenedor-tabla">
                <form id="search-form" action="" method="get">
                    <div class="center">
                        ...
                        <a href="Ascender.php" style="color: white;" class="my-button">Ver todos los colegas</a>
                    </div>
                </form>
                <br>
                <?php
                ...
                if (isset($_GET['id_usuario'])) {
                    ...
                    $sql = "SELECT id_usuario, nombre, paterno, materno, telefono, correo, nom_usuario, contraseña, escuela, tipo_usuario, nivel_usuario, departamento FROM usuarios WHERE nivel_usuario = '3' AND id_usuario = $id_usuario";
                } else {
                    $sql = "SELECT id_usuario, nombre, paterno, materno, telefono, correo, nom_usuario, contraseña, escuela, tipo_usuario, nivel_usuario, departamento FROM usuarios WHERE nivel_usuario = '3'";
                }
...
echo "<td><a href='#' onclick='mostrarVentana(\"aprobaciones.php?id_usuario=" . $row["id_usuario"] . "\")'>Aprobar</a></td>";
                        echo "</tr>";
                    }
                } else {
