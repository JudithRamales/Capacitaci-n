    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <h1 class="text-white">Departamento de administración.</h1>
            </div>
        </div>
    </div>
</header>
...
$query = "SELECT nombre, paterno, materno, escuela, id_usuario FROM usuarios WHERE departamento = 'Administracion'";
